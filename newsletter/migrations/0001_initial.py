    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_end_shipment', models.DateTimeField(blank=True, null=True, verbose_name='Дата и время окончания рассылки')),
                ('status', models.CharField(choices=[('END', 'Завершена'), ('CREATED', 'Создана'), ('START', 'Запущена')], default='Создана', verbose_name='Статус рассылки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('SUCCESS', 'Успешно'), ('NOT_SUCCESS', 'Не успешно')], default='SUCCESS', verbose_name='Статус попытки рассылки')),
